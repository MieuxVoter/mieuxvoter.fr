...
assets:
  ...
  rank_all:
    type: json
    path: 'ranked_time_merit_profile_FOUR_MENTIONS_IFOP_roll.json'
  time_profil_ow:
    type: json
  ...
  time_merite_profil_all:
    type: json
    path: 'time_merit_profile_FOUR_MENTIONS_Yannick Jadot_ALL.json'
  time_merite_profil_all_roll:
    type: json
    path: 'time_merit_profile_FOUR_MENTIONS_Yannick Jadot_ALL_roll.json'
...
<Plot {...time_merite_profil_all_roll} />
