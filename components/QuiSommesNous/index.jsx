        ...
        <div className="content-2">
          ...
          <div className="text-38 dmsans-medium-white-18px">
            <span className="dmsans-medium-tolopea-18px">
              Mieux Voter est une association créée en janvier 2018 pour
              promouvoir une nouvelle méthode de vote, le Jugement majoritaire.{" "}
              <br />
              <br />
              Mieux Voter agit pour faire connaître le Jugement Majoritaire au
              plus grand nombre et accompagne les collectivités publiques, les
